...
from .views import register_user, user_login, user_logout, edit_profile, fetch_user_data, fetch_productData, fetch_productDetailData, add_to_cart, fetch_user_cart_data
